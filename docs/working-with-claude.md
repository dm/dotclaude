...
Commit after EACH RED-GREEN-REFACTOR cycle. Use `/commit` for all commits — it handles staging, semantic format, and validation. Never batch multiple tasks into one commit.

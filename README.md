...
Install this repo as your `~/.claude`
...
1. Edit the markdown files in `~/.dotfiles/claude.sl/agents/`
...
1. Create a new `.md` file in `claude.sl/agents/`

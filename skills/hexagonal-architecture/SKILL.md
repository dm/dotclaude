...
description: Hexagonal architecture (ports & adapters) patterns for TypeScript. Use when implementing clean architecture boundaries, dependency inversion, or separating domain logic from infrastructure.
---

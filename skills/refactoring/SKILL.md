---
name: refactoring
description: Refactoring patterns and priority classification for the REFACTOR phase of TDD. Use after GREEN to assess and improve code structure.
---
...
// ASSESSMENT:
// High: Magic numbers 50, 5.99 -> extract constants

...
description: Collaborative refactoring using the Four Elements of Simple Design (minimize duplication, maximize clarity). Use when refactoring legacy code, improving code quality, or simplifying complex code with a human partner.
...
J. B. Rainsberger found: "removing duplication and improving clarity in small cycles creates a dynamo that drives simple design."

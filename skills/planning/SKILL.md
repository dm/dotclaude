---
name: planning
description: Planning work in small, known-good increments with TDD integration. Use when starting features, creating plans, or breaking work into reviewable steps.
---
...
- **Committing without approval** — Always wait for explicit "yes" before committing
...
- **Keeping plan files after feature complete** — Delete them; knowledge lives in CLAUDE.md, ADRs, and git history

---
name: slow-spec
description: Research the codebase and write a detailed specification with milestones for complex, multi-step work. Planning only — does not write code. Use /do-spec to execute an approved spec.
---
